...
bool Executer::Execute(const std::vector<amigo_whole_body_controller::ArmTaskGoal>& constraints)
{
    ...
    for (std::vector<amigo_whole_body_controller::ArmTaskGoal>::const_iterator it = constraints.begin();
        ...
        active_goal = wbc_client.sendGoal(goal,
                            boost::bind(&Executer::transition_cb, this, _1),
                            boost::bind(&Executer::feedback_cb,   this, _1, _2));
...
void Executer::feedback_cb(ArmTaskClient::GoalHandle goal_handle, const amigo_whole_body_controller::ArmTaskFeedbackConstPtr &feedback)
{
